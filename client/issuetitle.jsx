...
var IssueTitle = React.createClass({
	render: function() {
		...
		var icon = issue.pull_request ? <span title="Pull Request">{this.pullRequestIcon()}</span> : <span title="Issue">{this.issueIcon()}</span>;
		return (
			<span>
				<a name={issue.number} />
